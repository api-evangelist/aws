        ...
        "values": [
            {
                ...
                "value": "prefix-ats.iot.us-gov-west-1.amazonaws.com"
            },
            {
        ...
        "values": [
            {
                ...
                "value": "greengrass-ats.iot.us-gov-west-1.amazonaws.com"
            },
            {
        ...
        "values": [
            {
                ...
                "value": "application-autoscaling.us-gov-west-1.amazonaws.com"
            },
            {
...
```{
    "environment": {
        ...
        "values": [
            {
                "key": "aws_codestar_notifications_base_url",
...
```{
    "environment": {
        ...
        "values": [
            {
                "key": "aws_config_and_aws_config_rules_base_url",
...
```{
    "environment": {
        ...
        "values": [
            {
                "key": "aws_data_pipeline_base_url",
...
```{
    "environment": {
        ...
        "values": [
            {
                "key": "aws_database_migration_service_base_url",
...
```{
    "environment": {
        ...
        "values": [
            {
                "key": "aws_direct_connect_base_url",
...
```{
    "environment": {
        ...
        "values": [
            {
                "key": "aws_directory_service_base_url",
...
```{
    "environment": {
        ...
        "values": [
            {
                "key": "aws_elastic_beanstalk_base_url",
...
```{
    "environment": {
        ...
        "values": [
            {
                "key": "aws_elastic_beanstalk_health_service_base_url",
                "value": "elasticbeanstalk-health.us-gov-west-1.amazonaws.com"
            },
            {
...
```{
    "environment": {
        ...
        "values": [
            {
                "key": "elastic_load_balancing_base_url",
...
```{
    "environment": {
        ...
        "values": [
            {
                "key": "aws_firewall_manager_base_url",
...
```{
    "environment": {
        ...
        "values": [
            {
                "key": "aws_global_accelerator_base_url",
...
```{
    "environment": {
        ...
        "values": [
            {
                "key": "aws_ground_station_base_url",
...
```{
    "environment": {
        ...
        "values": [
            {
                "key": "aws_import\/export_base_url",
                "value": ""
            },
            {
...
```{
    "environment": {
        ...
        "values": [
            {
                "key": "aws_iot_analytics_base_url",
...
```{
    "environment": {
        ...
        "values": [
            {
                "key": "aws_iot_device_defender_base_url",
                "value": "iot.us-gov-west-1.amazonaws.com"
            },
            {
...
```{
    "environment": {
        ...
        "values": [
            {
                "key": "aws_iot_device_management_base_url",
                "value": "iot.us-gov-west-1.amazonaws.com"
            },
            {
...
```{
    "environment": {
        ...
        "values": [
            {
                "key": "aws_iot_greengrass_base_url",
                "value": "greengrass.us-gov-west-1.amazonaws.com"
            },
            {
...
```{
    "environment": {
        ...
        "values": [
            {
                "key": "aws_iot_things_graph_base_url",
...
```{
    "environment": {
        ...
        "values": [
            {
                "key": "aws_key_management_service_base_url",
...
```{
    "environment": {
        ...
        "values": [
            {
                "key": "aws_license_manager_base_url",
...
```{
    "environment": {
        ...
        "values": [
            {
                "key": "aws_elemental_mediaconnect_base_url",
...
```{
    "environment": {
        ...
        "values": [
            {
                "key": "aws_elemental_mediaconvert_base_url",
...
```{
    "environment": {
        ...
        "values": [
            {
                "key": "aws_elemental_medialive_base_url",
...
```{
    "environment": {
        ...
        "values": [
            {
                "key": "aws_elemental_mediastore_base_url",
...
```{
    "environment": {
        ...
        "values": [
            {
                "key": "aws_elemental_mediatailor_base_url",
...
```{
    "environment": {
        ...
        "values": [
            {
                "key": "aws_migration_hub_base_url",
...
```{
    "environment": {
        ...
        "values": [
            {
                "key": "aws_organizations_base_url",
...
```{
    "environment": {
        ...
        "values": [
            {
                "key": "aws_resource_access_manager_base_url",
...
```{
    "environment": {
        ...
        "values": [
            {
                "key": "aws_resource_groups_base_url",
...
```{
    "environment": {
        ...
        "values": [
            {
                "key": "resource_groups_tagging_api_base_url",
...
```{
    "environment": {
        ...
        "values": [
            {
                "key": "aws_secrets_manager_base_url",
...
```{
    "environment": {
        ...
        "values": [
            {
                "key": "aws_server_migration_service_base_url",
...
```{
    "environment": {
        ...
        "values": [
            {
                "key": "aws_serverless_application_repository_base_url",
...
```{
    "environment": {
        ...
        "values": [
            {
                "key": "aws_service_catalog_base_url",
...
```{
    "environment": {
        ...
        "values": [
            {
                "key": "aws_shield_advanced_base_url",
...
```{
    "environment": {
        ...
        "values": [
            {
                "key": "aws_step_functions_base_url",
...
```{
    "environment": {
        ...
        "values": [
            {
                "key": "aws_storage_gateway_base_url",
...
```{
    "environment": {
        ...
        "values": [
            {
                "key": "aws_transfer_for_sftp_base_url",
...
```{
    "environment": {
        ...
        "values": [
            {
                "key": "aws_waf_base_url",
                "value": "waf.amazonaws.com"
            },
            {
                "key": "aws_waf_region",
                "value": "us-east-2, us-east-1, us-west-1, us-west-2, ap-south-1, ap-northeast-2, ap-southeast-1, ap-southeast-2, ap-northeast-1, ca-central-1, eu-central-1, eu-west-1, eu-west-2, eu-west-3, eu-north-1, sa-east-1, us-gov-west-1"
